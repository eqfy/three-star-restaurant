...
DROP TABLE IF EXISTS ingredient_storage CASCADE;
DROP TABLE IF EXISTS dish_info CASCADE;
DROP TABLE IF EXISTS menu CASCADE;
DROP TABLE IF EXISTS address_info CASCADE;
DROP TABLE IF EXISTS restaurant CASCADE;
DROP TABLE IF EXISTS menu_dish_info CASCADE;
...
DROP TABLE IF EXISTS chef_dish_info CASCADE;
DROP TABLE IF EXISTS ingredient CASCADE;
DROP TABLE IF EXISTS restaurant_order CASCADE;
DROP TABLE IF EXISTS dish_order_item CASCADE;
